...
| `05_Queries_Users.sql` | Сложные выборки (JOIN, GROUP BY) для работы с пользователями |
| `06_Queries_Content.sql` | Аналитические SQL-запросы для генерации отчетов по задачам |
